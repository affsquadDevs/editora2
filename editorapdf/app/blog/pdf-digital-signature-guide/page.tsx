...
const slug = 'pdf-digital-signature-guide'
const articleTitle = 'Sign PDFs with Confidence'
const articleDescription = 'Apply signatures and verify intent in simple workflows.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Sign PDFs with Confidence</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Sign PDFs with Confidence</h1>
            <p className="text-lg text-surface-300">Apply signatures and verify intent in simple workflows.</p>
          </header>
