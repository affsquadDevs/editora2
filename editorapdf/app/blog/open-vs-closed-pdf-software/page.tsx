...
const slug = 'open-vs-closed-pdf-software'
const articleTitle = 'Open vs Closed PDF Editors'
const articleDescription = 'What changes for security, cost, and long-term control.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Open vs Closed PDF Editors</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Open vs Closed PDF Editors</h1>
            <p className="text-lg text-surface-300">What changes for security, cost, and long-term control.</p>
          </header>
