...
const slug = 'pdf-tables-to-csv-guide'
const articleTitle = 'Convert PDF Tables to CSV'
const articleDescription = 'Extract structured rows for spreadsheets and reporting.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Convert PDF Tables to CSV</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Convert PDF Tables to CSV</h1>
            <p className="text-lg text-surface-300">Extract structured rows for spreadsheets and reporting.</p>
          </header>
