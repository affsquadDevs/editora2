...
const slug = 'why-pdfiles-is-open'
const articleTitle = 'Why pdfiles Is Open Source'
const articleDescription = 'Why transparency and user trust matter for document tools.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Why pdfiles Is Open Source</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Why pdfiles Is Open Source</h1>
            <p className="text-lg text-surface-300">Why transparency and user trust matter for document tools.</p>
          </header>
