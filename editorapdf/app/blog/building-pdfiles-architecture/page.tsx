...
const slug = 'building-pdfiles-architecture'
const articleTitle = 'How We Built pdfiles'
const articleDescription = 'Architecture notes and trade-offs behind a browser-first editor.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">How We Built pdfiles</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">How We Built pdfiles</h1>
            <p className="text-lg text-surface-300">Architecture notes and trade-offs behind a browser-first editor.</p>
          </header>
