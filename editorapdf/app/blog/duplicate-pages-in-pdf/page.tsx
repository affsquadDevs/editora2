...
const slug = 'duplicate-pages-in-pdf'
const articleTitle = 'Duplicate PDF Pages Quickly'
const articleDescription = 'Reuse templates, repeated forms, and standardized sections.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Duplicate PDF Pages Quickly</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Duplicate PDF Pages Quickly</h1>
            <p className="text-lg text-surface-300">Reuse templates, repeated forms, and standardized sections.</p>
          </header>
