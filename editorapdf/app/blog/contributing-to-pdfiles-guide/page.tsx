...
const slug = 'contributing-to-pdfiles-guide'
const articleTitle = 'A Beginner Guide to Contributing'
const articleDescription = 'Simple ways to help improve pdfiles, even on day one.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">A Beginner Guide to Contributing</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">A Beginner Guide to Contributing</h1>
            <p className="text-lg text-surface-300">Simple ways to help improve pdfiles, even on day one.</p>
          </header>
