...
const slug = 'privacy-first-pdf-tech-stack'
const articleTitle = 'Technology Behind Privacy-First Editing'
const articleDescription = 'How client-side rendering and export keep files local.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Technology Behind Privacy-First Editing</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Technology Behind Privacy-First Editing</h1>
            <p className="text-lg text-surface-300">How client-side rendering and export keep files local.</p>
          </header>
