...
const slug = 'rotate-pdf-pages-guide'
const articleTitle = 'Rotate PDF Pages the Right Way'
const articleDescription = 'Fix scan orientation across one page or the entire file.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Rotate PDF Pages the Right Way</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Rotate PDF Pages the Right Way</h1>
            <p className="text-lg text-surface-300">Fix scan orientation across one page or the entire file.</p>
          </header>
