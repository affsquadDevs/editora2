...
const slug = 'reorder-pdf-pages-guide'
const articleTitle = 'Reorder PDF Pages Fast'
const articleDescription = 'Rebuild document flow without recreating the file.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Reorder PDF Pages Fast</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Reorder PDF Pages Fast</h1>
            <p className="text-lg text-surface-300">Rebuild document flow without recreating the file.</p>
          </header>
