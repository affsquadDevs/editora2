...
const slug = 'pdf-header-footer-guide'
const articleTitle = 'Add Headers and Footers to PDF'
const articleDescription = 'Standardize files with labels, dates, and custom text.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Add Headers and Footers to PDF</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Add Headers and Footers to PDF</h1>
            <p className="text-lg text-surface-300">Standardize files with labels, dates, and custom text.</p>
          </header>
