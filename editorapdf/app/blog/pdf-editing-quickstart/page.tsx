...
const slug = 'pdf-editing-quickstart'
const articleTitle = 'How to Edit a PDF in Minutes'
const articleDescription = 'A practical walkthrough for fast edits with no extra apps.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">How to Edit a PDF in Minutes</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">How to Edit a PDF in Minutes</h1>
            <p className="text-lg text-surface-300">A practical walkthrough for fast edits with no extra apps.</p>
          </header>
