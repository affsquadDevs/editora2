...
const slug = 'redact-sensitive-pdf-data'
const articleTitle = 'Redact Sensitive PDF Content'
const articleDescription = 'Permanently remove private data before sharing files.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Redact Sensitive PDF Content</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Redact Sensitive PDF Content</h1>
            <p className="text-lg text-surface-300">Permanently remove private data before sharing files.</p>
          </header>
