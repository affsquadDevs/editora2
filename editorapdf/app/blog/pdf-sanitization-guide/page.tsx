...
const slug = 'pdf-sanitization-guide'
const articleTitle = 'Sanitize a PDF Before Sending'
const articleDescription = 'Strip metadata and hidden artifacts for cleaner distribution.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Sanitize a PDF Before Sending</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Sanitize a PDF Before Sending</h1>
            <p className="text-lg text-surface-300">Strip metadata and hidden artifacts for cleaner distribution.</p>
          </header>
