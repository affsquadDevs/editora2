...
const slug = 'remove-pages-from-pdf'
const articleTitle = 'Delete Unwanted PDF Pages'
const articleDescription = 'Remove draft pages, blanks, and duplicates in a few clicks.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Delete Unwanted PDF Pages</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Delete Unwanted PDF Pages</h1>
            <p className="text-lg text-surface-300">Remove draft pages, blanks, and duplicates in a few clicks.</p>
          </header>
