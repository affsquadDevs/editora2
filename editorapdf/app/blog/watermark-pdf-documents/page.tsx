...
const slug = 'watermark-pdf-documents'
const articleTitle = 'Add Watermarks to Protect PDFs'
const articleDescription = 'Stamp ownership, status, or confidentiality on every page.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Add Watermarks to Protect PDFs</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Add Watermarks to Protect PDFs</h1>
            <p className="text-lg text-surface-300">Stamp ownership, status, or confidentiality on every page.</p>
          </header>
