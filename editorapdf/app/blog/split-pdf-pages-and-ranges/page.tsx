...
const slug = 'split-pdf-pages-and-ranges'
const articleTitle = 'Split a PDF by Pages or Ranges'
const articleDescription = 'Break big files into smaller parts that are easier to share.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Split a PDF by Pages or Ranges</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Split a PDF by Pages or Ranges</h1>
            <p className="text-lg text-surface-300">Break big files into smaller parts that are easier to share.</p>
          </header>
