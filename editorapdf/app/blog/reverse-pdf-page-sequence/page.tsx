...
const slug = 'reverse-pdf-page-sequence'
const articleTitle = 'Reverse PDF Page Order'
const articleDescription = 'Flip page sequence for scans and print-related tasks.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Reverse PDF Page Order</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Reverse PDF Page Order</h1>
            <p className="text-lg text-surface-300">Flip page sequence for scans and print-related tasks.</p>
          </header>
