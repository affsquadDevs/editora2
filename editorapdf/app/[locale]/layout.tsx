...
import { SITE_URL as siteUrl, SITE_NAME } from '@/lib/site-config'
...
const localeSeo: Record<AppLocale, { title: string; description: string; ogLocale: string }> = {
  en: {
    title: 'pdfiles — Privacy-First PDF Workspace Online',
    description: 'pdfiles is a browser-native PDF workspace for editing, conversion, page operations, signing, and cleanup. Work faster with privacy-first processing and no account friction.',
    ogLocale: 'en_US',
  },
  uk: {
    title: 'pdfiles — приватний онлайн-простір для роботи з PDF',
    description: 'pdfiles — це онлайн-простір для редагування, конвертації й структурування PDF з локальною обробкою та фокусом на приватність.',
    ogLocale: 'uk_UA',
  },
  fr: {
    title: 'Éditer PDF en ligne gratuitement - Sans installation ni inscription | pdfiles',
  ...
  de: {
    title: 'PDF online kostenlos bearbeiten - Ohne Installation und Anmeldung | pdfiles',
  ...
  es: {
    title: 'Editar PDF en línea gratis - Sin instalación ni registro | pdfiles',
  ...
  it: {
    title: 'Modifica PDF online gratis - Senza installazione e registrazione | pdfiles',
