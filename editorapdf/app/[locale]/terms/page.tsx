...
const termsContent: Record<AppLocale, TermsContent> = {
  en: {
    ...
    disclaimer: {
      ...
      intro: 'pdfiles is provided "AS IS", without any warranties. By using the service, you agree that:',
      items: [
    ...
    adNote: {
      ...
      text: 'pdfiles is a completely free service. To support the site, third-party advertisements, partner offers, and affiliate links may be displayed.',
    },
    sections: [
      { heading: '1. Acceptance of Terms', content: 'By using pdfiles, you confirm your agreement to these terms. If you do not agree, please do not use the service.' },
      { heading: '2. Service Description', content: ['pdfiles is a browser-based PDF tool that allows you to view, edit, convert, merge, split, and export PDF files.', 'Most processing is performed locally in your browser. You are responsible for verifying results before using documents.'] },
      ...
      { heading: '6. Limitation of Liability', content: 'To the extent permitted by law, pdfiles is not liable for direct or indirect damages, data loss, loss of profits, or other consequences related to the use or inability to use the service.' },
      ...
      { heading: '8. Intellectual Property', content: 'The pdfiles platform rights belong to its owners. You retain rights to your own files and content that you process through the service.' },
    ...
    contactTitle: 'Email:', contactEmail: 'hello@example.com', contactPage: 'Contact page:', copyright: '© 2026 pdfiles. All rights reserved.', privacyLink: 'Privacy Policy', contactLink: 'Contact Us',
  },
  uk: {
    ...
    disclaimer: {
      ...
      intro: 'pdfiles надається «ЯК Є», без будь-яких гарантій. Використовуючи сервіс, ви погоджуєтесь, що:',
      items: [
    ...
    adNote: {
      ...
      text: 'pdfiles є повністю безкоштовним сервісом. Для підтримки роботи сайту можуть показуватися сторонні рекламні матеріали, партнерські пропозиції та афілійовані посилання.',
    },
    sections: [
      { heading: '1. Прийняття умов', content: 'Користуючись pdfiles, ви підтверджуєте згоду з цими умовами. Якщо ви не погоджуєтесь з ними, будь ласка, не використовуйте сервіс.' },
      { heading: '2. Опис сервісу', content: ['pdfiles — це браузерний інструмент для роботи з PDF, який дозволяє переглядати, редагувати, конвертувати, об\'єднувати, розділяти та експортувати PDF-файли.', 'Більшість обробки виконується локально у вашому браузері. Ви несете відповідальність за перевірку результатів перед використанням документів.'] },
      ...
      { heading: '6. Обмеження відповідальності', content: 'У межах, дозволених законодавством, pdfiles не несе відповідальності за прямі або непрямі збитки, втрату даних, прибутку чи інші наслідки, пов\'язані з використанням або неможливістю використання сервісу.' },
      ...
      { heading: '8. Інтелектуальна власність', content: 'Права на платформу pdfiles належать її власникам. Ви зберігаєте права на власні файли та контент, які обробляєте через сервіс.' },
    ...
    contactTitle: 'Електронна пошта:', contactEmail: 'hello@example.com', contactPage: 'Сторінка контактів:', copyright: '© 2026 pdfiles. Усі права захищено.', privacyLink: 'Політика конфіденційності', contactLink: 'Зв\'язатися з нами',
  },
  de: {
    ...
    disclaimer: {
      ...
      intro: 'pdfiles wird "WIE BESEHEN" ohne jegliche Garantien bereitgestellt. Durch die Nutzung des Dienstes stimmen Sie zu, dass:',
      items: [
    ...
    adNote: {
      ...
      text: 'pdfiles ist ein völlig kostenloser Dienst. Zur Unterstützung der Website können Drittanbieterwerbung, Partnerangebote und Affiliate-Links angezeigt werden.',
    },
    sections: [
      { heading: '1. Annahme der Bedingungen', content: 'Durch die Nutzung von pdfiles bestätigen Sie Ihre Zustimmung zu diesen Bedingungen. Falls Sie nicht zustimmen, nutzen Sie den Dienst bitte nicht.' },
      { heading: '2. Dienstbeschreibung', content: ['pdfiles ist ein browserbasiertes PDF-Tool, mit dem Sie PDF-Dateien anzeigen, bearbeiten, konvertieren, zusammenführen, aufteilen und exportieren können.', 'Die meiste Verarbeitung erfolgt lokal in Ihrem Browser. Sie sind für die Überprüfung der Ergebnisse vor der Verwendung von Dokumenten verantwortlich.'] },
      ...
      { heading: '6. Haftungsbeschränkung', content: 'Soweit gesetzlich zulässig, haftet pdfiles nicht für direkte oder indirekte Schäden, Datenverlust, Gewinnverlust oder andere Folgen im Zusammenhang mit der Nutzung oder Nichtnutzbarkeit des Dienstes.' },
      ...
      { heading: '8. Geistiges Eigentum', content: 'Die Rechte an der pdfiles-Plattform gehören ihren Eigentümern. Sie behalten die Rechte an Ihren eigenen Dateien und Inhalten, die Sie über den Dienst verarbeiten.' },
    ...
    contactTitle: 'E-Mail:', contactEmail: 'hello@example.com', contactPage: 'Kontaktseite:', copyright: '© 2026 pdfiles. Alle Rechte vorbehalten.', privacyLink: 'Datenschutzrichtlinie', contactLink: 'Kontakt aufnehmen',
  },
  fr: {
    ...
    disclaimer: {
      ...
      intro: 'pdfiles est fourni "TEL QUEL", sans aucune garantie. En utilisant le service, vous acceptez que :',
      items: [
    ...
    adNote: {
      ...
      text: 'pdfiles est un service entièrement gratuit. Pour soutenir le site, des publicités tierces, des offres partenaires et des liens d\'affiliation peuvent être affichés.',
    },
    sections: [
      { heading: '1. Acceptation des conditions', content: 'En utilisant pdfiles, vous confirmez votre accord avec ces conditions. Si vous n\'êtes pas d\'accord, veuillez ne pas utiliser le service.' },
      { heading: '2. Description du service', content: ['pdfiles est un outil PDF basé sur navigateur qui vous permet de visualiser, modifier, convertir, fusionner, diviser et exporter des fichiers PDF.', 'La plupart du traitement est effectué localement dans votre navigateur. Vous êtes responsable de vérifier les résultats avant d\'utiliser les documents.'] },
      ...
      { heading: '6. Limitation de responsabilité', content: 'Dans la mesure permise par la loi, pdfiles n\'est pas responsable des dommages directs ou indirects, des pertes de données, de bénéfices ou d\'autres conséquences liées à l\'utilisation ou à l\'impossibilité d\'utiliser le service.' },
      ...
      { heading: '8. Propriété intellectuelle', content: 'Les droits sur la plateforme pdfiles appartiennent à ses propriétaires. Vous conservez les droits sur vos propres fichiers et contenus que vous traitez via le service.' },
    ...
    contactTitle: 'E-mail :', contactEmail: 'hello@example.com', contactPage: 'Page de contact :', copyright: '© 2026 pdfiles. Tous droits réservés.', privacyLink: 'Politique de confidentialité', contactLink: 'Nous contacter',
  },
  es: {
    ...
    disclaimer: {
      ...
      intro: 'pdfiles se proporciona "TAL CUAL", sin ninguna garantía. Al usar el servicio, usted acepta que:',
      items: [
    ...
    adNote: {
      ...
      text: 'pdfiles es un servicio completamente gratuito. Para apoyar el sitio, pueden mostrarse anuncios de terceros, ofertas de socios y enlaces de afiliados.',
    },
    sections: [
      { heading: '1. Aceptación de los términos', content: 'Al usar pdfiles, confirma su acuerdo con estos términos. Si no está de acuerdo, por favor no use el servicio.' },
      { heading: '2. Descripción del servicio', content: ['pdfiles es una herramienta PDF basada en navegador que le permite ver, editar, convertir, fusionar, dividir y exportar archivos PDF.', 'La mayor parte del procesamiento se realiza localmente en su navegador. Usted es responsable de verificar los resultados antes de usar los documentos.'] },
      ...
      { heading: '6. Limitación de responsabilidad', content: 'En la medida permitida por la ley, pdfiles no es responsable de daños directos o indirectos, pérdida de datos, pérdida de ganancias u otras consecuencias relacionadas con el uso o la imposibilidad de usar el servicio.' },
      ...
      { heading: '8. Propiedad intelectual', content: 'Los derechos sobre la plataforma pdfiles pertenecen a sus propietarios. Usted conserva los derechos sobre sus propios archivos y contenidos que procesa a través del servicio.' },
    ...
    contactTitle: 'Correo electrónico:', contactEmail: 'hello@example.com', contactPage: 'Página de contacto:', copyright: '© 2026 pdfiles. Todos los derechos reservados.', privacyLink: 'Política de privacidad', contactLink: 'Contáctenos',
  },
  it: {
    ...
    disclaimer: {
      ...
      intro: 'pdfiles è fornito "COSÌ COM\'È", senza alcuna garanzia. Utilizzando il servizio, accetti che:',
      items: [
    ...
    adNote: {
      ...
      text: 'pdfiles è un servizio completamente gratuito. Per supportare il sito, potrebbero essere visualizzate pubblicità di terze parti, offerte partner e link di affiliazione.',
    },
    sections: [
      { heading: '1. Accettazione dei termini', content: 'Utilizzando pdfiles, confermi il tuo accordo con questi termini. Se non sei d\'accordo, ti preghiamo di non utilizzare il servizio.' },
      { heading: '2. Descrizione del servizio', content: ['pdfiles è uno strumento PDF basato su browser che ti consente di visualizzare, modificare, convertire, unire, dividere ed esportare file PDF.', 'La maggior parte dell\'elaborazione viene eseguita localmente nel tuo browser. Sei responsabile della verifica dei risultati prima di utilizzare i documenti.'] },
      ...
      { heading: '6. Limitazione di responsabilità', content: 'Nella misura consentita dalla legge, pdfiles non è responsabile per danni diretti o indiretti, perdita di dati, perdita di profitti o altre conseguenze legate all\'uso o all\'impossibilità di utilizzare il servizio.' },
      ...
      { heading: '8. Proprietà intellettuale', content: 'I diritti sulla piattaforma pdfiles appartengono ai suoi proprietari. Tu mantieni i diritti sui tuoi file e contenuti che elabori tramite il servizio.' },
    ...
    contactTitle: 'Email:', contactEmail: 'hello@example.com', contactPage: 'Pagina contatti:', copyright: '© 2026 pdfiles. Tutti i diritti riservati.', privacyLink: 'Informativa sulla privacy', contactLink: 'Contattaci',
  },
}
