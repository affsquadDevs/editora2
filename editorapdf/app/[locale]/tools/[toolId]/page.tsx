...
export function generateMetadata({
  ...
  if (!tool) {
    return {
      title: 'PDF Tool | pdfiles',
      description: 'Free online PDF tools — no installation, no signup required.',
    };
  }

  const title = `${tool.title} Online Free — No Signup | pdfiles`;
        ...
        step: [
          {
            ...
            position: 1,
            name: 'Open the tool',
            text: `Go to the ${tool.title} tool on pdfiles. No account or installation required — it works directly in your browser.`,
          },
          {
            '@type': 'HowToStep',
            position: 2,
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: `${tool.description}. Simply open the tool on pdfiles, upload your PDF file, and the processing happens instantly in your browser — no installation or signup required.`,
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: `Yes, ${tool.title} on pdfiles is completely free. There are no subscriptions, no hidden fees, and no account required. You can use it as many times as you need.`,
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: `Your files are 100% private. All processing happens locally in your browser — your PDF is never uploaded to any server. pdfiles does not store, transmit, or have access to your documents.`,
            },
          },
          {
            '@type': 'Question',
