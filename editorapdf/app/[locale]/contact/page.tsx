              ...
              <div className="flex items-start gap-4 p-6 rounded-xl bg-surface-800/30 border border-surface-700/50 hover:border-accent-500/30 transition-all animate-fade-in-up delay-200">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3">
                    <a href={GITHUB_REPO_URL} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-surface-800 hover:bg-primary-500/20 border border-surface-700 hover:border-primary-500/50 flex items-center justify-center text-surface-400 hover:text-primary-400 transition-all group" aria-label="GitHub">
                      <Github size={20} strokeWidth={1.5} className="transition-transform group-hover:scale-110" />
                    </a>
                  </div>
                </div>
              </div>
