...
1. **Key File**: `public/d6a52731014140d19cdd5a2b8bba4abb.txt`
   - Must be accessible at: `http://localhost:3000/d6a52731014140d19cdd5a2b8bba4abb.txt`
...
curl -X POST http://localhost:3000/api/indexnow \
  ...
  -d '{"url": "http://localhost:3000/new-page"}'
```
...
curl -X POST http://localhost:3000/api/indexnow \
  -H "Content-Type: application/json" \
  -d '{"urls": ["http://localhost:3000/page1", "http://localhost:3000/page2"]}'
```
...
Submit custom URLs:
```bash
node scripts/submit-indexnow.js http://localhost:3000/page1 http://localhost:3000/page2
```
...
// Submit a single URL
await submitUrlToIndexNow('http://localhost:3000/new-page');
...
1. **Check Key File**: Visit `http://localhost:3000/d6a52731014140d19cdd5a2b8bba4abb.txt`
...
`https://pdfiles.io/d6a52731014140d19cdd5a2b8bba4abb.txt`

### API Returns 400 Error

- Verify URLs are from the correct domain (pdfiles.io)
