# Contributing to pdfiles

First off, thank you for considering contributing to pdfiles! 

pdfiles is an open-source project, and we love to receive contributions from our community. There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests, or writing code which can be incorporated into pdfiles itself.
...
Contributors will be recognized in our README and project documentation. Thank you for helping make pdfiles better! 🙏

## License

By contributing to pdfiles, you agree that your contributions will be licensed under the MIT License.
