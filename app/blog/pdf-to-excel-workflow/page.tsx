...
const slug = 'pdf-to-excel-workflow'
const articleTitle = 'Convert PDF to Excel'
const articleDescription = 'Move table data from PDF into editable workbook format.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Convert PDF to Excel</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Convert PDF to Excel</h1>
            <p className="text-lg text-surface-300">Move table data from PDF into editable workbook format.</p>
          </header>
