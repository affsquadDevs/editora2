...
const slug = 'pdf-compression-handbook'
const articleTitle = 'Compress PDF Files Smartly'
const articleDescription = 'Reduce file size while keeping readability and layout intact.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Compress PDF Files Smartly</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Compress PDF Files Smartly</h1>
            <p className="text-lg text-surface-300">Reduce file size while keeping readability and layout intact.</p>
          </header>
