...
const slug = 'pdf-text-extraction-guide'
const articleTitle = 'Extract Text from PDF'
const articleDescription = 'Capture searchable text for notes, analysis, and automation.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Extract Text from PDF</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Extract Text from PDF</h1>
            <p className="text-lg text-surface-300">Capture searchable text for notes, analysis, and automation.</p>
          </header>
