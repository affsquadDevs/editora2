...
const slug = 'merge-pdf-workflow-guide'
const articleTitle = 'Merge PDF Files Without Losing Quality'
const articleDescription = 'Combine reports, scans, and appendices into one clean document.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Merge PDF Files Without Losing Quality</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Merge PDF Files Without Losing Quality</h1>
            <p className="text-lg text-surface-300">Combine reports, scans, and appendices into one clean document.</p>
          </header>
