...
const slug = 'pdf-to-html-export-guide'
const articleTitle = 'Convert PDF to HTML'
const articleDescription = 'Publish PDF content to the web with cleaner structure.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Convert PDF to HTML</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Convert PDF to HTML</h1>
            <p className="text-lg text-surface-300">Publish PDF content to the web with cleaner structure.</p>
          </header>
