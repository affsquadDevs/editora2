...
const slug = 'pdf-split-by-bookmarks-guide'
const articleTitle = 'Split PDF by Bookmarks'
const articleDescription = 'Create chapter files automatically from document structure.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Split PDF by Bookmarks</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Split PDF by Bookmarks</h1>
            <p className="text-lg text-surface-300">Create chapter files automatically from document structure.</p>
          </header>
