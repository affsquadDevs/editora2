...
const slug = 'images-to-pdf-conversion-guide'
const articleTitle = 'Convert Images into a PDF'
const articleDescription = 'Bundle photos and scans into one shareable document.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Convert Images into a PDF</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Convert Images into a PDF</h1>
            <p className="text-lg text-surface-300">Bundle photos and scans into one shareable document.</p>
          </header>
