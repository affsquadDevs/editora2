...
const slug = 'insert-blank-pdf-pages'
const articleTitle = 'Insert Blank PDF Pages'
const articleDescription = 'Add separators, covers, or writing space exactly where needed.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Insert Blank PDF Pages</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Insert Blank PDF Pages</h1>
            <p className="text-lg text-surface-300">Add separators, covers, or writing space exactly where needed.</p>
          </header>
