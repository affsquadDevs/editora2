...
const slug = 'extract-pdf-pages-fast'
const articleTitle = 'Extract Specific PDF Pages'
const articleDescription = 'Pull only the pages you need for clients, school, or legal workflows.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Extract Specific PDF Pages</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Extract Specific PDF Pages</h1>
            <p className="text-lg text-surface-300">Pull only the pages you need for clients, school, or legal workflows.</p>
          </header>
