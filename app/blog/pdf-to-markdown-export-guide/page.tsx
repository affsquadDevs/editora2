...
const slug = 'pdf-to-markdown-export-guide'
const articleTitle = 'Convert PDF to Markdown'
const articleDescription = 'Turn static pages into editable content for docs and wikis.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Convert PDF to Markdown</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Convert PDF to Markdown</h1>
            <p className="text-lg text-surface-300">Turn static pages into editable content for docs and wikis.</p>
          </header>
