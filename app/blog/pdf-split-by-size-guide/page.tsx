...
const slug = 'pdf-split-by-size-guide'
const articleTitle = 'Split PDF by File Size'
const articleDescription = 'Prepare upload-ready chunks for strict file-size limits.'
      ...
      <article className="flex-1 p-6 py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-surface-400 mb-6">
            ...
            <span className="text-surface-300">Split PDF by File Size</span>
          </nav>

          <header className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Split PDF by File Size</h1>
            <p className="text-lg text-surface-300">Prepare upload-ready chunks for strict file-size limits.</p>
          </header>
