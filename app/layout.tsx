...
const siteDescription = 'pdfiles is a browser-native PDF workspace for editing, conversion, page operations, signing, and cleanup. Work faster with privacy-first processing and no account friction.'
const siteTitle = 'pdfiles — Privacy-First PDF Workspace Online'
...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'pdfiles Team', url: siteUrl }],
  creator: 'pdfiles',
  publisher: 'pdfiles',
  formatDetection: {
    email: false,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'pdfiles - Professional PDF Editor - Edit PDF documents online instantly without installation or signup',
      },
    ],
  },
  twitter: {
...
export default function RootLayout({
  ...
  const videoJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'VideoObject',
    name: 'pdfiles PDF Editor Demo',
    description: 'Watch how to use pdfiles to edit PDFs online for free',
  ...
  const organizationJsonLd = {
    ...
    name: 'pdfiles',
    alternateName: 'pdfiles Online PDF Editor',
    url: siteUrl,
    logo: {
      '@type': 'ImageObject',
      url: `${siteUrl}/logo.svg`,
    ...
    description: 'pdfiles is an online PDF workspace focused on clean workflows, local processing, and practical document operations for everyday teams.',
    foundingDate: '2026',
  ...
  const itemListJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: 'pdfiles Workspace Capabilities',
    description: 'Core capabilities available in the pdfiles browser workspace',
    itemListElement: [
      {
        '@type': 'ListItem',
        position: 1,
  ...
  const softwareSourceCodeJsonLd = {
    ...
    name: 'pdfiles - Open Source PDF Editor',
    ...
    contributor: [
      {
        ...
        url: `${GITHUB_REPO_URL}/graphs/contributors`,
      },
    ],
  }
  ...
  return (
    <html lang={locale}>
      <head>
        ...
        <meta name="copyright" content="pdfiles" />
        <meta name="reply-to" content={CONTACT_EMAIL} />
        <meta name="owner" content="pdfiles" />
        ...
        <meta property="og:image:alt" content="pdfiles - Professional PDF Editor - Edit PDF documents online instantly without installation or signup" />
        ...
        <meta name="twitter:image:alt" content="pdfiles - Professional PDF Editor" />
        ...
        <meta name="msapplication-TileColor" content="#022c22" />
