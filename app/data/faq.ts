...
export const faqData: FAQItem[] = [
  {
    ...
    answer: 'Simply visit pdfiles, click "Edit PDF" or drag and drop your PDF file into the browser. No installation or signup required. You can instantly start editing text, adding images, annotating, and modifying your PDF document completely free.',
    keywords: ['edit pdf online free', 'how to edit pdf', 'free pdf editor'],
  },
  {
    question: 'Do I need to install software to edit PDF files?',
    answer: 'No! pdfiles works entirely in your web browser. There\'s no software to download or install. Just open your browser, visit our website, and start editing PDFs instantly. It works on Windows, Mac, Linux, and even Chromebooks.',
    keywords: ['pdf editor no installation', 'online pdf editor', 'browser-based pdf editor'],
  },
  {
    question: 'Do I need to create an account or sign up?',
    answer: 'No signup required! You can use pdfiles immediately without creating an account, logging in, or providing any personal information. Simply drop your PDF and start editing right away.',
  ...
  {
    question: 'What file size limit does pdfiles support?',
    answer: 'pdfiles supports PDF files up to 25MB in size. For optimal performance, we recommend PDFs with fewer than 50 pages. All processing happens on your device, so larger files may take longer depending on your computer\'s performance.',
    keywords: ['pdf file size limit', 'max pdf size', 'pdf editor limitations'],
  },
  {
    question: 'Can I edit PDF files on my phone or tablet?',
    answer: 'Yes! pdfiles is fully responsive and works on mobile devices and tablets. However, for the best editing experience, we recommend using a desktop or laptop with a larger screen and mouse for precise editing.',
    keywords: ['mobile pdf editor', 'edit pdf on phone', 'tablet pdf editor'],
  },
  {
    question: 'Does pdfiles work offline?',
    answer: 'Yes, once the page is loaded, pdfiles works completely offline. All PDF processing happens locally in your browser without requiring an internet connection. You can edit PDFs even without WiFi.',
    keywords: ['offline pdf editor', 'pdf editor no internet', 'browser pdf editor'],
  },
  {
    question: 'What browsers are supported?',
    answer: 'pdfiles works in all modern browsers including Google Chrome, Mozilla Firefox, Microsoft Edge, Safari, Opera, and Brave. We recommend using the latest version of your browser for the best experience and performance.',
  ...
  {
    question: 'Is pdfiles really free? Are there hidden costs?',
    answer: 'Yes, pdfiles is completely free to use. There are no hidden fees, no premium tiers, no subscriptions, and no feature limitations. All editing tools are available to everyone at no cost.',
  ...
  },
  {
    ...
    answer: 'pdfiles is a leading free open-source PDF editor that works entirely in your browser. It offers text editing, image insertion, shape tools, page management, and more - all without requiring installation or signup. View the source code on GitHub to verify its open-source nature.',
  ...
  },
  {
    ...
    answer: 'pdfiles processes all PDFs locally in your browser. Your files never leave your device and are never uploaded to any server. All editing happens client-side using PDF.js and pdf-lib libraries. This ensures complete privacy and security.',
  ...
  },
  {
    ...
    answer: 'pdfiles is one of the most private PDF editors available. All processing happens locally in your browser - no server uploads, no data storage, no tracking. Your PDFs never leave your device. The open-source code allows you to verify the privacy claims yourself.',
  ...
  },
  {
    ...
    answer: 'Yes! pdfiles is a free open-source alternative to Adobe Acrobat. While it may not have all enterprise features, it offers core PDF editing capabilities including text editing, image insertion, annotations, page management, and more - all for free with full source code available on GitHub.',
