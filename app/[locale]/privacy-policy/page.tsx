...
const privacyContent: Record<AppLocale, PrivacyContent> = {
  en: {
    ...
    priorityDesc: 'pdfiles processes all PDFs entirely in your browser. Your files never leave your device and are never uploaded to our servers.',
    ...
    sections: [
      { heading: '1. Information We Collect', subsections: [
        { heading: '1.1 Personal Information', content: 'We do not require registration, account creation, or submission of personal data to use the core pdfiles tools.' },
      ...
      { heading: '6. Your Rights and Choices', content: 'Depending on your country of residence, you may have the right to access information about data processing, restrict such processing, delete certain data, or opt out of personalized advertising. For privacy inquiries, contact us at hello@example.com.' },
      ...
      { heading: '9. International Users', content: 'pdfiles is available in various countries. Your PDF files are not transferred between countries as they are processed locally in the browser. However, third-party analytics or advertising services may process technical data outside your jurisdiction according to their own policies.' },
    ...
    contactTitle: 'Email:', contactEmail: 'hello@example.com', contactPage: 'Contact page:',
    copyright: '© 2026 pdfiles. Your privacy matters.', termsLink: 'Terms of Service', contactLink: 'Contact',
  },
  uk: {
    title: 'Політика конфіденційності', updated: 'Останнє оновлення: 30 січня 2026',
    priorityTitle: 'Ваша приватність для нас пріоритет',
    priorityDesc: 'pdfiles обробляє PDF повністю у вашому браузері. Ваші файли не залишають пристрій і не завантажуються на наші сервери.',
    ...
    sections: [
      { heading: '1. Які дані ми збираємо', subsections: [
        { heading: '1.1 Особисті дані', content: 'Ми не вимагаємо реєстрації, створення акаунта чи передачі персональних даних для роботи з основними інструментами pdfiles.' },
      ...
      { heading: '6. Ваші права та вибір', content: 'Залежно від країни проживання ви можете мати право на доступ до інформації про обробку даних, обмеження такої обробки, видалення окремих даних або відмову від персоналізованої реклами. Для запитів щодо конфіденційності звертайтесь на hello@example.com.' },
      ...
      { heading: '9. Міжнародні користувачі', content: 'pdfiles доступний у різних країнах. Ваші PDF-файли не передаються між країнами, бо обробляються локально у браузері. Водночас сторонні аналітичні чи рекламні сервіси можуть обробляти технічні дані за межами вашої юрисдикції відповідно до власних політик.' },
    ...
    contactTitle: 'Електронна пошта:', contactEmail: 'hello@example.com', contactPage: 'Сторінка контактів:',
    copyright: '© 2026 pdfiles. Ваша приватність має значення.', termsLink: 'Умови використання', contactLink: 'Контакти',
  },
  de: {
    ...
    priorityDesc: 'pdfiles verarbeitet alle PDFs vollständig in Ihrem Browser. Ihre Dateien verlassen nie Ihr Gerät und werden nie auf unsere Server hochgeladen.',
    ...
    sections: [
      { heading: '1. Informationen, die wir sammeln', subsections: [
        { heading: '1.1 Persönliche Informationen', content: 'Wir verlangen keine Registrierung, Kontoerstellung oder Übermittlung persönlicher Daten zur Nutzung der Kernfunktionen von pdfiles.' },
    ...
    contactTitle: 'E-Mail:', contactEmail: 'hello@example.com', contactPage: 'Kontaktseite:',
    copyright: '© 2026 pdfiles. Ihre Privatsphäre ist uns wichtig.', termsLink: 'Nutzungsbedingungen', contactLink: 'Kontakt',
  },
  fr: {
    ...
    priorityDesc: 'pdfiles traite tous les PDFs entièrement dans votre navigateur. Vos fichiers ne quittent jamais votre appareil et ne sont jamais téléchargés sur nos serveurs.',
    ...
    sections: [
      { heading: '1. Informations que nous collectons', subsections: [
        { heading: '1.1 Informations personnelles', content: 'Nous n\'exigeons pas d\'inscription, de création de compte ou de soumission de données personnelles pour utiliser les outils principaux d\'pdfiles.' },
      ...
      { heading: '9. Utilisateurs internationaux', content: 'pdfiles est disponible dans différents pays. Vos fichiers PDF ne sont pas transférés entre pays car ils sont traités localement dans le navigateur. Cependant, les services d\'analyse ou de publicité tiers peuvent traiter des données techniques en dehors de votre juridiction selon leurs propres politiques.' },
    ...
    contactTitle: 'E-mail :', contactEmail: 'hello@example.com', contactPage: 'Page de contact :',
    copyright: '© 2026 pdfiles. Votre vie privée compte.', termsLink: 'Conditions d\'utilisation', contactLink: 'Contact',
  },
  es: {
    ...
    priorityDesc: 'pdfiles procesa todos los PDFs completamente en su navegador. Sus archivos nunca salen de su dispositivo y nunca se cargan en nuestros servidores.',
    ...
    sections: [
      { heading: '1. Información que recopilamos', subsections: [
        { heading: '1.1 Información personal', content: 'No requerimos registro, creación de cuenta ni envío de datos personales para usar las herramientas principales de pdfiles.' },
      ...
      { heading: '6. Sus derechos y opciones', content: 'Según su país de residencia, puede tener derecho a acceder a información sobre el procesamiento de datos, restringir dicho procesamiento, eliminar ciertos datos u optar por no recibir publicidad personalizada. Para consultas de privacidad, contáctenos en hello@example.com.' },
    ...
    contactTitle: 'Correo electrónico:', contactEmail: 'hello@example.com', contactPage: 'Página de contacto:',
    copyright: '© 2026 pdfiles. Su privacidad importa.', termsLink: 'Términos de servicio', contactLink: 'Contacto',
  },
  it: {
    ...
    priorityDesc: 'pdfiles elabora tutti i PDF interamente nel tuo browser. I tuoi file non lasciano mai il tuo dispositivo e non vengono mai caricati sui nostri server.',
    ...
    sections: [
      { heading: '1. Informazioni che raccogliamo', subsections: [
        { heading: '1.1 Informazioni personali', content: 'Non richiediamo registrazione, creazione di account o invio di dati personali per utilizzare gli strumenti principali di pdfiles.' },
    ...
    contactTitle: 'Email:', contactEmail: 'hello@example.com', contactPage: 'Pagina contatti:',
    copyright: '© 2026 pdfiles. La tua privacy è importante.', termsLink: 'Termini di servizio', contactLink: 'Contatto',
  },
}
